                    ...
                    <div class="tab-content">
                        <div class="tab-pane inverterTabPane show active" id="messages1">
                            ...
                            <div class="single_dashboard_vt">
                                ...
                                <div class="animation_soler_vt" id="energy-data-log">
                                    <!-- Change Class -->
                                    ...
                                    <div class="btn_Generation"><img src="{{ asset('assets/images/Generation.png')}}"
                                        ...
                                        <div class="Generation_text">DC Input Power
                                            <span id="dc-input-power">{{ $current['dc_power']}}</span></div>
                                    </div>
                                    <!-- Change Class -->
                                    <a href="#"
                                    ...
                                    <div class="btn_Grid"><img src="{{ asset('assets/images/Grid.png')}}" alt="">
                                        <div class="Grid_text {{ $plant->system_type_id != 1 ? '' : 'grid_hide' }}">Net
                                            Grid
                                            <span
                                                id="net-grid">{{ $currentDataValues['grid_type'] == '-ve' ? '-' : '' }}{{ $current['grid'] }}</span>
                                        </div>
                                    </div>
                                    <!-- Change Class -->
                                    <a href="#"
                                    ...
                                    <div class="btn_meter">
                                        <div class="output_text">Output Power <span
                                                id="output-power">{{ $current['generation'] }}</span>
                                        </div>
                                        <img src="{{ asset('assets/images/meter.png')}}" alt="">
                                        <div class="meter_text {{ $plant->system_type_id != 1 ? '' : 'grid_hide' }}">
                                            Load <span id="load-power">{{ $current['consumption'] }}</span></div>
                                    </div>
                                    <!-- Change Class -->
                                    <div
        ...
        <div class="row">
            <div class="col-md-4 pr-md-0">
                ...
                ">
                    ...
                    <p>Created Date<span>{{ date('d-m-Y', strtotime($plant->created_at)) }}</span></p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="bg_blue2_vt">
                                        ...
                                        <div class="plantsTodayYesterdayChart" id="plant-power-array">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="data_name_vt">
                                                    <ul id="plant-generation-power-data">
                                                        <li><span>Today's Generation</span> <samp>{{ $daily['generation'] }} </samp>
                                                        </li>
                                                        <li><span>Monthly Generation</span> <samp>{{ $monthly['generation'] }} </samp>
                                                        </li>
                                                        <li><span>Yearly Generation</span> <samp>{{ $yearly['generation'] }}</samp>
                                                        </li>
                                                        <li><span>Total Generation</span> <samp>{{ $total['generation'] }}</samp>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
...
{{--                    </div>--}}
    ...
    <script>
        ...
        setInterval(function () {
            ...
            $.ajax({
                url: "{{ route('admin.plants.energy.graph.details') }}",
                method: "GET",
                dataType: 'json',
                data:
                    {
                ...
                success: function (data) {
                    let energyData = document.getElementById('energy-data-log');
                    let dcInputData = data['currentDataValues']['dc_power'];
                    let zeroIndexValue = '';
                    let secondIndexValue = '';
                    let thirdIndexValue = '';
                    let fourthIndexValue = '';
                    let sixthIndexValue = '';
                    let sevenththIndexValue = '';
                    let ninthIndex = '';
                    let eleventhIndex = '';
                    let gridType = '';
                    if (dcInputData > 0) {
                        zeroIndexValue = 'arrowbottomtoo';
                        secondIndexValue = 'animated-button1';
                        thirdIndexValue = 'arrowAnim'
                    } else {
                        zeroIndexValue = 'stop_all';
                        secondIndexValue = 'Stop_left';
                        thirdIndexValue = 'stop_all';
                    }
                    if (data['currentDataValues']['consumption'] > 0) {
                        fourthIndexValue = 'arrowbottomtop';
                        ninthIndex = 'animated-button10';
                    } else {
                        fourthIndexValue = 'stop_all';
                        ninthIndex = 'Stop_bottom';
                    }
                    if (data['currentDataValues']['grid'] > 0) {
                        if (data['currentDataValues']['grid_type'] === '+ve') {
                            sixthIndexValue = 'animated-button6';
                            sevenththIndexValue = 'gridtohomeleft';
                            eleventhIndex = 'gridtohome';
                        } else {
                            sixthIndexValue = 'animated-button12';
                            sevenththIndexValue = 'arrowright';
                            eleventhIndex = 'arrowbottom';
                            gridType = '-'
                        }
                    } else {
                        sixthIndexValue = 'Stop_right';
                        sevenththIndexValue = 'stop_all';
                        eleventhIndex = 'stop_all';
                    }
                    energyData.children[0].removeAttribute('id');
                    energyData.children[2].removeAttribute('class');
                    energyData.children[3].removeAttribute('id');
                    energyData.children[4].removeAttribute('id');
                    energyData.children[6].removeAttribute('class');
                    energyData.children[7].removeAttribute('id');
                    energyData.children[9].removeAttribute('class');
                    energyData.children[11].removeAttribute('id');
                    energyData.children[0].setAttribute('id', zeroIndexValue);
                    energyData.children[2].setAttribute('class', secondIndexValue);
                    energyData.children[3].setAttribute('id', thirdIndexValue);
                    energyData.children[4].setAttribute('id', fourthIndexValue);
                    energyData.children[6].setAttribute('class', sixthIndexValue);
                    energyData.children[7].setAttribute('id', sevenththIndexValue);
                    energyData.children[9].setAttribute('class', ninthIndex);
                    energyData.children[11].setAttribute('id', eleventhIndex);
                    document.getElementById('dc-input-power').innerHTML = data['energyData']['dc_power'];
                    document.getElementById('net-grid').innerHTML = gridType + ' ' + data['energyData']['grid'];
                    document.getElementById('output-power').innerHTML = data['energyData']['generation'];
                    document.getElementById('consumption').innerHTML = data['energyData']['consumption'];
        ...
        window.onload = function () {
            ...
            $('#btnConvert').click(function () {
                ...
                for (i = 0; i < Timedata.length; i++) {
                    csvData.push(new Array(Timedata[i], generationdata[i], costsaving[i]));
                }
        ...
        setInterval(function () {
            var plantID = $('#plantID').val();
            $.ajax({
                url: "{{ route('admin.plant.energy.flow.data') }}",
                method: "GET",
                // data: {
                //     'plantID': plantID,
                //     'serialNo': pvSerialNo,
        ...
        setInterval(function () {
            $.ajax({
                url: "{{ route('admin.plant.detail.power.graph') }}",
                type: 'GET',
                data: {
                    'id': plantID,
                },
                success: function (data) {
                   // console.log(document.getElementById('plant-power-array').children[0].children[0])
                    document.getElementById('plant-power-array').children[0].children[0].innerHTML = data['powerArray']['current_power'];
                    document.getElementById('plant-power-array').children[1].children[0].innerHTML = data['powerArray']['total_capacity']
                    plantPowerGraph(data['plantPowerGraphGraph'])
                },
                error: function (data) {
                    console.log(data);
                }
        ...
        {{--setInterval(function () {--}}
        {{--    $.ajax({--}}
        {{--        url: "{{ route('admin.plant.detail.generation.graph') }}",--}}
        {{--        type: 'GET',--}}
        {{--        data: {--}}
        {{--            'id': plantID,--}}
        {{--        },--}}
        {{--        success: function (data) {--}}
        {{--            document.getElementById('plant-generation-power-data').children[0].children[1].innerHTML = data['daily'];--}}
        {{--            document.getElementById('plant-generation-power-data').children[1].children[1].innerHTML = data['monthly']--}}
        {{--            document.getElementById('plant-generation-power-data').children[2].children[1].innerHTML = data['yearly']--}}
        {{--            document.getElementById('plant-generation-power-data').children[3].children[1].innerHTML = data['total']--}}
        {{--        },--}}
        {{--        error: function (data) {--}}
        {{--            console.log(data);--}}
        {{--        }--}}
        ...
        {{--setInterval(function () {--}}
        {{--    $.ajax({--}}
        {{--        url: "{{ route('admin.plant.detail.saving.graph') }}",--}}
        {{--        type: 'GET',--}}
        {{--        data: {--}}
        {{--            'id': plantID,--}}
        {{--        },--}}
        ...
        function inverterExportGraphAjax(serial_no, date, time, inverterCheckBoxArray) {
            ...
            $.ajax({
                ...
                url: "{{ url('admin/ExportInvertergraph') }}",
                success: function (data) {
