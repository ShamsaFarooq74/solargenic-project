                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-header">
                                <h2 class="All-graph-heading-vt">Notification</h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-borderless table-centered table-nowrap">
                            ...
                            <tbody class="btn_a_vt">
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn_pin_vt" data-toggle="modal" data-animation="fadein" data-target=".bs-example-modal-center"><i class="fa fa-pen"></i></button> Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        Password Reset Plant Offline Plant
                                    </td>
                                    <td class="checkbox_check">
                                        <div class="checkbox checkbox-primary">
                                            <input id="checkbox1" type="checkbox">
                                ...
                                <tr>
                                    <td>
                                        Plant Alert /Fault Plant Alert /Fault
                                    </td>
                                    <td class="checkbox_check">
                                        <div class="checkbox checkbox-primary">
                                            <input id="checkbox1" type="checkbox">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="home-b1">
                                            ...
                                            <button type="button" class="email_sms_app_btn">Save</button>
                                        </div>
