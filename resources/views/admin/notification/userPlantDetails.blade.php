            ...
            <div class="btn_text_area" id="iverterCheckBoxSelectBtn" style="display: none;">
                <div class="drop_bt_area_vt">
                    <div class="multiselect">
                        ...
                        <div id="checkboxinverter">
                            <label for="one">
                            <input type="checkbox" class="inverterCheckBox" name="inverterCheckBox[]" id="one" value="output_power"  checked/>Output Power</label>
                            <label for="two">
                            <input type="checkbox" class="inverterCheckBox"  name="inverterCheckBox[]" id="two" value="dc_power"  />Input DC Power</label>
                            <label for="three">
                            <input type="checkbox" class="inverterCheckBox"  name="inverterCheckBox[]" id="three" value="normalize_power"  />Normalize Power</label>
                        </div>
                    </div>
                ...
                <div class="date_mont_tabs graphDateTimeDiv" style="display: none;">
                    ...
                    <div class="day_month_year_vt" id="inverter_day_month_year_vt_month" style="display: none;">
                        ...
                        <button class="btn_right_vt"><i id="inverterGraphForwardMonth" class="fa fa-caret-right"></i></button>
                    </div>
                ...
                <ul class="nav nav-pills navtab-bg nav-justified" id="inverterTab">
                    <li class="nav-item">
                        <a href="#messages1" data-toggle="tab" aria-expanded="false" class="nav-link inverterTabLink active">
                            Energy Flow
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#inverterTabID" data-toggle="tab" aria-expanded="false" class="nav-link inverterTabLink ">
                            Inverter
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#messages2" data-toggle="tab" aria-expanded="false" class="nav-link inverterTabLink">
                            PV
                        </a>
                    </li>
                    @if($plant->plant_has_emi == 'Y')
                    <li class="nav-item">
                        <a href="#messages3" data-toggle="tab" aria-expanded="false" class="nav-link inverterTabLink">
                            EMI
                        </a>
                    </li>
                    @endif
                    ...
                    <div class="tab-pane inverterTabPane show active" id="messages1">
                        ...
                        <div class="single_dashboard_vt">
                            ...
                            <div class="animation_soler_vt">
                                ...
                                <div class="btn_Consumption"><img src="{{ asset('assets/images/Consumption.png')}}" alt=""></div>
                                <!-- Change Class -->
                                <a href="#" class="{{ $currentDataValues['dc_power'] > 0 ? 'animated-button1' : 'Stop_left' }}">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                ...
                                <!-- Change Class -->
                                <div id="{{ $currentDataValues['consumption'] > 0 ? 'arrowbottomtop' : 'stop_all' }}">
                                    <div class="arrowSliding">
                                        <div class="arrow"></div>
                                    </div>
                                    <div class="arrowSliding delay1">
                                ...
                                <div class="btn_Generation"><img src="{{ asset('assets/images/Generation.png')}}" alt="">
                                    <div class="Generation_text">DC Input Power <span>{{ $current['dc_power']}}</span></div>
                                </div>
                                <!-- Change Class -->
                                <a href="#" class="{{ $currentDataValues['grid'] > 0 ? ($currentDataValues['grid_type'] == '+ve' ? 'animated-button6' : 'animated-button12') : 'Stop_right' }}">
                                ...
                                <!-- Change Class -->
                                <div id="{{ $currentDataValues['grid'] > 0 ? ($currentDataValues['grid_type'] == '+ve' ? 'gridtohomeleft' : 'arrowright') : 'stop_all' }}">
                                ...
                                <div class="btn_Grid"><img src="{{ asset('assets/images/Grid.png')}}" alt="">
                                    <div class="Grid_text {{ $plant->system_type_id != 1 ? '' : 'grid_hide' }}">Net Grid <span>{{ $currentDataValues['grid_type'] == '-ve' ? '-' : '' }}{{ $current['grid'] }}</span></div>
                                </div>
                                <!-- Change Class -->
                                <a href="#" class="{{ $currentDataValues['consumption'] > 0 ? 'animated-button10' : 'Stop_bottom' }}">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                ...
                                <div class="btn_meter">
                                    <div class="output_text">Output Power <span>{{ $current['generation'] }}</span></div>
                                    <img src="{{ asset('assets/images/meter.png')}}" alt="">
                                    <div class="meter_text {{ $plant->system_type_id != 1 ? '' : 'grid_hide' }}">Load <span>{{ $current['consumption'] }}</span></div>
                                </div>
                                <!-- Change Class -->
                                <div id="{{ $currentDataValues['grid'] > 0 ? ($currentDataValues['grid_type'] == '+ve' ? 'gridtohome' : 'arrowbottom') : 'stop_all' }}">
                    ...
                    <div class="tab-pane inverterTabPane" id="inverterTabID">
                        ...
                        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel" data-interval="false">
                            <ol class="carousel-indicators">
                                ...
                                <li data-target="#carouselExampleCaptions" data-index="{{$key}}" data-slide-to="{{ $item->dv_inverter_serial_no }}" class="{{ $key == 0 ? 'active' : '' }}"></li>
                                @endforeach
                            </ol>
                                ...
                                <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                    <div class="row">
                                        <div class="col-sm-1 graph_view_data">
                                            <div class="nav flex-column nav-pills nav-pills-tab inverterGraphDataTabs" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                <a class="nav-link mb-2 graphDataView" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile-{{ $item->dv_inverter_serial_no }}" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                                                    <span>Graphical View</span></a>
                                                <a class="nav-link active show mb-2 graphDataView" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home-{{ $item->dv_inverter_serial_no }}" role="tab" aria-controls="v-pills-home" aria-selected="true">
                                                    <span>Data</span></a>
                                            </div>
                                        </div> <!-- end col-->
                                        <div class="col-sm-11">
                                            <div class="tab-content pt-0">
                                                <div class="tab-pane graphDataViewTabPane fade" id="v-pills-profile-{{ $item->dv_inverter_serial_no }}" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                                    @php
                                                    ...
                                                    <!--                                                    --><?php //plantPowerGraphData
                                                                                                                ?>
                                                    <div class="card">
                                                        <div class="spinner-border text-success inverterGraphSpinner plantGraphSpinner" role="status">
                                                            <span class="sr-only">Loading...</span>
                                                        </div>
                                                        <div class="inverterGraphError plantGraphError" style="display: none;">
                                                            <span>Some Error Occured</span>
                                                        </div>

                                                        <div class="card-box" dir="ltr" id="inverterGraphDiv">
                                                            <div id="inverterGraphChartDiv"></div>
                                                            <br>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane graphDataViewTabPane fade active show" id="v-pills-home-{{ $item->dv_inverter_serial_no }}" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="graph_to_vt">
                                                                <div class="{{ in_array($item->inverter_state_code, [768,769,770,771,772,773,774]) ? 'tol_area_vt_red' : 'tol_area_vt' }}">
                                                                    <h4>Power</h4>
                                                            ...
                                                            <div class="menu_unt">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <button type="button" class="offline_vt">{{ $item->inverter_state }}
                                                                        </button>
                                                                    </li>
                                                                    <li>
                                                                        <h4>Start Time</h4>
                                                        ...
                                                        <div class="col-md-4 one_to_vt">
                                                            <div class="table-responsive pr-0 pr-md-3">
                                                                <div class="over_area_vt">
                                                                    <table class="table mb-0">
                                                                        <thead class="over_flow_vt">
                                                                            <tr>
                                                                                <th>DC</th>
                                                                                <th>Voltage</th>
                                                                                <th>Current</th>
                                                                        ...
                                                                        <tbody class="body_th_vt">
                                                                            @if($plant->is_online == 'N')
                                                                                @for($i = 0; $i < 3; $i++)
                                                                                    <tr>
                                                                                        <th scope="row">-</th>
                                                                                        <td>-</td>
                                                                                        <td>-</td>
                                                                                        {{-- <td>{{ $mppt->mppt_power }} kW</td> --}}
                                                                                    </tr>
                                                                                @endfor
                                                                            @elseif($plant->faultLevel == 1)
                                                                                @if(!in_array($item->inverter_state_code, [768,769,770,771,772,773,774]))
                                                                                    @if($item->inverter_mppt_detail && !empty($item->inverter_mppt_detail))
                                                                                        @foreach ($item->inverter_mppt_detail as $key1 => $mppt)
                                                                                            @if($mppt->mppt_voltage > 0)
                                                                                                <tr>
                                                                                                    <th scope="row">PV{{ $mppt->mppt_number }}</th>
                                                                                                    <td>{{ $mppt->mppt_voltage }} V</td>
                                                                                                    <td>{{ $mppt->mppt_current }} A</td>
                                                                                                    {{-- <td>{{ $mppt->mppt_power }} kW</td> --}}
                                                                                                </tr>
                                                                                            @endif
                                                                                        @endforeach
                            ...
                            <a class="left carousel-control-prev carousel_control_prev" href="#carouselExampleCaptions" role="button" data-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="right carousel-control-next carousel_control_next" href="#carouselExampleCaptions" role="button" data-slide="next">
                        ...
                        <div class="tab-pane inverterTabPane cd_powervt_vt px-0" id="messages2">
                            ...
                            <div class="_carousl_vt_area pvGraphTabDataDiv">
                                ...
                                <div class="check_area_vt">
                                    <div class="form-check">
                                        <input type="checkbox" name="pvCheckBox[]" value="pv_current" class="form-check-input pvCheckBox" id="exampleCheck1" checked>
                                        <label class="form-check-label" for="exampleCheck1">Current</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" name="pvCheckBox[]" value="pv_voltage" class="form-check-input pvCheckBox" id="exampleCheck2">
                                        <label class="form-check-label" for="exampleCheck2">Voltage</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" name="pvCheckBox[]" value="pv_power" class="form-check-input pvCheckBox" id="exampleCheck3">
                                        <label class="form-check-label" for="exampleCheck3">Power</label>
                                    </div>
                                </div>
                                <div class="_date_vt">
                                    <div class="day_month_year_vt" id="pv_day_month_year_vt_day">
                                        <button class="btn_left_vt"><i id="pvGraphPreviousDay" class="fa fa-caret-left"></i></button>
                                        <div class="c-datepicker-date-editor c-datepicker-single-editor J-yearMonthDayPicker-single-pv mt10">
                                            <i class="fa fa-calendar-alt"></i>
                                            <input type="text" autocomplete="off" name="pvGraphDay" id="pvGraphDay" placeholder="Select" class="c-datepicker-data-input" value="">
                                        </div>
                                        <button class="btn_right_vt"><i id="pvGraphForwardDay" class="fa fa-caret-right"></i></button>
                                    </div> 
                                </div>
                                <div class="pt-3">
                                    <div class="spinner-border text-success pvGraphSpinner plantGraphSpinner" role="status">
                                        <span class="sr-only">Loading...</span>
                                    </div>
                                    <div class="pvGraphError plantGraphError" style="display: none;">
                                        <span>Some Error Occured</span>
                                    </div>
                                    <div class="col-md-12" id="pvGraphDivv" style="margin-top: 50px !important;">
                                        {{-- <div class="bg_blue2_vt pvGraphDiv" id="pvGraphDivv"> --}}
                                            <div id="plantsPVChart"></div>
                                        {{-- </div> --}}
                                        <div class="bg_blue2_vt noPVDiv" style="display: none;">
                            ...
                            <div id="carousel" class="carousel slide" data-ride="carousel" data-interval="false">
                                <ol class="carousel-indicators pvCarouselList">
                                    @foreach ($plantInverters as $key1 => $item1)
                                        <li data-target="#carousel" data-index="{{$key1}}" data-slide-to="{{ $item1->dv_inverter }}" class="{{ $key1 == 0 ? 'active' : '' }}"></li>
                                    @endforeach
                                </ol>
                                <div class="carousel-inner" role="listbox">
                                    @foreach ($plantInverters as $key1 => $item1)
                                        <div class="carousel-item {{ $key1 == 0 ? 'active' : '' }}">
                                            <div class="row">
                                                <div class="col-sm-1 graph_view_data">
                                                    <div class="nav flex-column nav-pills nav-pills-tab pvGraphDataTabs" id="v-pills-tab"
                                                        role="tablist" aria-orientation="vertical">
                                                        <a class="nav-link mb-2" id="v-pills-profile-tab-pv" data-toggle="pill"
                                                            href="#v-pills-profile-pv-{{ $item1->dv_inverter }}" role="tab" aria-controls="v-pills-profile"
                                                            aria-selected="false">
                                                            <span>PV Graph</span></a>
                                                        <a class="nav-link active show mb-2" id="v-pills-home-tab-pv"
                                                            data-toggle="pill" href="#v-pills-home-pv-{{ $item1->dv_inverter }}" role="tab"
                                                ...
                                                <div class="col-sm-11">
                                                    <div class="tab-content pt-0">
                                                        <div class="tab-pane fade" id="v-pills-profile-pv-{{ $item1->dv_inverter }}" role="tabpanel"
                                                            aria-labelledby="v-pills-profile-tab-pv">
                                                            123456
                                                        </div>
                                                        <div class="tab-pane fade active show" id="v-pills-home-pv-{{ $item1->dv_inverter }}" role="tabpanel"
                                                            aria-labelledby="v-pills-home-tab-pv">
                                                            <div class="top_text_dc">
                                                                <p>Inverter Serial No : <span>{{ $item1->dv_inverter }}</span></p>
                                                                <p>Total Installed DC Power : <span>{{ $item1->installed_dc_input_power }}</span></p>
                                                                <p>Total DC input Power : <span>{{ $item1->dc_input_power }} kW</span></p>
                                                            </div>
                                                            <div class="table-responsive">
                                                                <table class="table table-borderless mb-0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @for ($i = 1; $i <= 12; $i++)
                                                                            @foreach ($item1->pv_values as $pv)
                                                                                @if($pv->mppt_number == $i)
                                                                                <td>{{ number_format((float)$pv->mppt_voltage, 2, '.', '') }}V</td>
                                                                                @endif
                                                                            @endforeach
                                                                        @endfor
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        @for ($i = 1; $i <= 12; $i++)
                                                                            @foreach ($item1->pv_values as $pv)
                                                                                @if($pv->mppt_number == $i)
                                                                                    <td>{{ number_format((float)$pv->mppt_current, 2, '.', '') }}A</td>
                                                                                @endif
                                                                            @endforeach
                                                                        @endfor
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        @for ($i = 1; $i <= 12; $i++)
                                                                            @foreach ($item1->pv_values as $pv)
                                                                                @if($pv->mppt_number == $i)
                                                                                    <td>{{ number_format((float)$pv->mppt_power, 2, '.', '') }}kW</td>
                                                                                @endif
                                                                            @endforeach
                                                                        @endfor
                                                                    </tr>
                                ...
                                @if(count($plantInverters) > 1)
                                <a class="carousel-control-prev leftPVCarousel" href="#carousel" role="button" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="carousel-control-next rightPVCarousel" href="#carousel" role="button" data-slide="next">
                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Next</span>
                                </a>
                                @endif                                                                                                                                                               </div>
                    ...
                    <div class="tab-pane inverterTabPane" id="messages3">
                        ...
                        <div class="drop_search_vt">
                            <div class="multiselect">
                                ...
                                <div id="checkboxes">
                                    <label for="one">
                                    <input type="checkbox" class="emiCheckBox" name="emiCheckBox[]" id="one" value="pv_temperature" />PV Temperature</label>
                                    <label for="two">
                                    <input type="checkbox" class="emiCheckBox" name="emiCheckBox[]" id="two" value="ambient_temperature" />Ambient Temperature</label>
                                    <label for="three">
                                    <input type="checkbox" class="emiCheckBox" name="emiCheckBox[]" id="three" value="irradiance" checked/>Irradiance</label>
                                    <label for="three">
                                    <input type="checkbox" class="emiCheckBox" name="emiCheckBox[]" id="four" value="wind_speed" />Wind Speed</label>
                                </div>
                            </div>
                        ...
                        <div class="cland_card_vt">
                            <div class="day_month_year_vt" id="emi_day_month_year_vt_day">
                                <button class="btn_left_vt"><i id="emiGraphPreviousDay" class="fa fa-caret-left"></i></button>
                                <div class="c-datepicker-date-editor c-datepicker-single-editor J-yearMonthDayPicker-single-emi mt10">
                                    <i class="fa fa-calendar-alt"></i>
                                    <input type="text" autocomplete="off" name="emiGraphDay" id="emiGraphDay" placeholder="Select" class="c-datepicker-data-input" value="">
                                </div>
                                <button class="btn_right_vt"><i id="emiGraphForwardDay" class="fa fa-caret-right"></i></button>
                            </div>
                        ...
                        <div class="pt-3">
                            <div class="spinner-border text-success emiGraphSpinner plantGraphSpinner" role="status">
                                <span class="sr-only">Loading...</span>
                            </div>
        ...
        <div class="col-md-4 pr-md-0">
            <div class="card-stat-vt  mb-2" style="padding-bottom: 0;">
                <div class="card-header">
                    ...
                    <a class="eidt-profil-vt" href="{{ route('admin.edit.plant', ['id' => $plant->id]) }}" style="padding-top: 5px; padding-bottom: 5px;">Edit </a>
                </div>
                <br>
                <div class="stat-area-hed-vt" style="background: none;">
                    <img src="{{ $plant->faultLevel != 0 ? asset('assets/images/plant_detail_fault.png') : ($plant->is_online == 'P_Y' ? asset('assets/images/plant_detail_partial_online.png') :  ($plant->is_online == 'Y' ? asset('assets/images/plant_detail_online.png') : asset('assets/images/plant_detail_offline.png'))) }}" alt="" style="
                    position: absolute;
                    z-index: 99;
                    width: 39px;
                    top: 75px;
                ...
                ">
                    ...
                    <img style="    background-size: cover;
                        ...
                        padding: 0 10px;
                        border-radius: 20px;
                        height: 140px;" src="{{ asset('assets/images/050121143546.70017_6A.jpeg') }}" alt="Plant Picture" width="50">
                </div>
            ...
            <div class="weth_area_vt">
                ...
                <ul>
                    @for($i=0;$i<count($weatherDetails);$i++) @if($i==0) <li class="one_wather" style="width: 33.3%;">

                        <h5 class="m-0 mb-1">{{$weatherDetails[0]['day']}}</h5>
                        <p>{{$weatherDetails[0]['todayMin']}}/{{$weatherDetails[0]['todayMax']}}* <img src="{{ asset('assets/images/weather.png') }}" alt="" width="50px"></p>

                        <h3>Sunrise <span>{{$weatherDetails[0]['sunrise']}}</span></h3>
                        <h3>Sunrise <span>{{$weatherDetails[0]['sunset']}}</span></h3>
                        </li>
                        @endif
                        @if($i !== 0)
                        <li>
                        ...
                        <div class="row">
                            ...
                            <div class="env_benefits_vt">
                                <div class="day_month_year_vt" id="alert_day_month_year_vt_day">
                                    <button class="btn_left_vt"><i id="alertGraphPreviousDay" class="fa fa-caret-left"></i></button>
                                    ...
                                    <button class="btn_right_vt"><i id="alertGraphForwardDay" class="fa fa-caret-right"></i></button>
                                </div>
                                <div class="day_month_year_vt" id="alert_day_month_year_vt_month" style="display: none;">
                                    <button class="btn_left_vt"><i id="alertGraphPreviousMonth" class="fa fa-caret-left"></i></button>
                                    <div class="mt40">
                                    ...
                                    <button class="btn_right_vt"><i id="alertGraphForwardMonth" class="fa fa-caret-right"></i></button>
                                </div>
                                <div class="day_month_year_vt" id="alert_day_month_year_vt_year" style="display: none;">
                                    <button class="btn_left_vt"><i id="alertGraphPreviousYear" class="fa fa-caret-left"></i></button>
                                    <div class="mt40">
                                    ...
                                    <button class="btn_right_vt"><i id="alertGraphForwardYear" class="fa fa-caret-right"></i></button>
                                </div>
                            ...
                            <div class="spinner-border text-success alertGraphSpinner plantGraphSpinner" role="status">
                                <span class="sr-only">Loading...</span>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="bg_blue2_vt alertGraphDiv" id="alertGraphDivv">
                                    ...
                                    <h3>
                                        <div class="totalAlertDiv">0</div> <span>Total Alerts</span>
                                    </h3>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="data_pla_vt alertGraphDiv">
                                    <ul>
                                        <li><samp class="blue5_vt"></samp> Alarm : <span class="totalAlarmDiv"> 0</span></li>
                                        <li><samp class="blue4_vt"></samp> Fault : <span class="totalFaultDiv"> 0</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="env_benefits_vt">
                                <div class="day_month_year_vt" id="env_day_month_year_vt_day">
                                    <button class="btn_left_vt"><i id="envGraphPreviousDay" class="fa fa-caret-left"></i></button>
                                    ...
                                    <button class="btn_right_vt"><i id="envGraphForwardDay" class="fa fa-caret-right"></i></button>
                                </div>
                                <div class="day_month_year_vt" id="env_day_month_year_vt_month" style="display: none;">
                                    <button class="btn_left_vt"><i id="envGraphPreviousMonth" class="fa fa-caret-left"></i></button>
                                    <div class="mt40">
                                    ...
                                    <button class="btn_right_vt"><i id="envGraphForwardMonth" class="fa fa-caret-right"></i></button>
                                </div>
                                <div class="day_month_year_vt" id="env_day_month_year_vt_year" style="display: none;">
                                    <button class="btn_left_vt"><i id="envGraphPreviousYear" class="fa fa-caret-left"></i></button>
                                    <div class="mt40">
                                    ...
                                    <button class="btn_right_vt"><i id="envGraphForwardYear" class="fa fa-caret-right"></i></button>
                                </div>
                            ...
                            <div class="spinner-border text-success envGraphSpinner plantGraphSpinner" role="status">
                                <span class="sr-only">Loading...</span>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="environmental_vt" style="border: none;">
                                    ...
                                    <img src="{{ asset('assets/images/factory.png') }}" alt="tower" style="margin-top: 10px;">
                            ...
                            <div class="col-md-12">
                                <div class="data_pla_vt">
                                    <ul>
                                        ...
                                        <li><samp class="blue4_vt"></samp> Total CO<sub style="padding-right: 2px;">2 </sub> Emission Reduction :
        ...
        <div class="col-md-8">
                                ...
                                <div class="card_box_vt">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="data_name_vt">
                                                <ul>
                                                    <li><span>Daily Bought</span> {{ $daily['boughtEnergy'] }}</li>
                                                    <li><span>Monthly Bought</span> {{ $monthly['boughtEnergy'] }}</li>
                                                    <li><span>Yearly Bought</span> {{ $yearly['boughtEnergy'] }}</li>
                                                    <li><span>Total Bought</span> {{ $total['boughtEnergy'] }}</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="data_name_vt">
                                                <ul>
                                                    ...
                                                    <li><span>Monthly Sell</span> {{ $monthly['sellEnergy'] }}</li>
                                                    <li><span>Yearly Sell</span> {{ $yearly['sellEnergy'] }}</li>
                                ...
                                <div class="card_box_vt">
                                    <div class="margin_vt">
                                            ...
                                            <div class="dataname_vt">
                                                <ul>
                                                    <li><span> Wind Speed </span> {{ $plant->latest_inverter_emi_details && $plant->latest_inverter_emi_details->wind_speed ? $plant->latest_inverter_emi_details->wind_speed : '---' }} m/s
                                                    </li>
                                                    <li><span>Wind Direction</span> {{ $plant->latest_inverter_emi_details && $plant->latest_inverter_emi_details->wind_direction ? $plant->latest_inverter_emi_details->wind_direction : '---' }} North </li>
                                                </ul>
                                            </div>
                                    </div>
                                </div> <!-- end card-box-->
                            ...
                            <div class="col-sm-12 col-md-3 px-0">
                                <div class="card_box_vt">
                                    <div class="margin_vt">
                                            ...
                                            <div class="dataname_vt">
                                                <ul>
                                                    <li><span>PV Temprature</span> {{ $plant->latest_inverter_emi_details && $plant->latest_inverter_emi_details->pv_temperature ? $plant->latest_inverter_emi_details->pv_temperature : '---' }} <sup>o</sup>C</li>
                                                    <li><span>Ambient Temprature</span> {{ $plant->latest_inverter_emi_details && $plant->latest_inverter_emi_details->temperature ? $plant->latest_inverter_emi_details->temperature : '---' }} <sup>o</sup>C</li>
                                                </ul>
                                        </div>
                                    </div>
                                </div> <!-- end card-box-->
                            ...
                            <div class="col-sm-12 col-md-6 pl-0">
                                <div class="card_box_vt">
                                    <div class="margin2_vt">
                                            ...
                                            <div class="dataname_vt">
                                                <ul>
                                                    <li><span>Irradiance</span> {{ $plant->latest_inverter_emi_details && $plant->latest_inverter_emi_details->radiant_line ? $plant->latest_inverter_emi_details->radiant_line : '---' }} W/m<sup>2</sup></li>
                                                    <li><span>Horizontal Irradiance</span> {{ $plant->latest_inverter_emi_details && $plant->latest_inverter_emi_details->horiz_radiant_line ? $plant->latest_inverter_emi_details->horiz_radiant_line : '---' }} W/m<sup>2</sup></li>
                                                    <li><span>Total Horizontal radiation exposure</span> {{ $plant->latest_inverter_emi_details && $plant->latest_inverter_emi_details->horiz_radiant_total ? $plant->latest_inverter_emi_details->horiz_radiant_total : '---' }} W/m<sup>2</sup></li>
                                                </ul>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="row margin3_vt">
                                                <div class="col-md-12">
                                                    <div class="data_name_vt pt-2">
                                                        <ul>
                                                            <li><span>Today's Irradiance</span> {{ $daily['irradiance'] }} kWh/m<sup>2</sup></li>
                                                            <li><span>Monthly Irradiance</span> {{ $monthly['irradiance'] }} kWh/m<sup>2</sup></li>
                                                            <li><span>Yearly Irradiance</span> {{ $yearly['irradiance'] }} kWh/m<sup>2</sup></li>
                                                            <li><span>Total Irradiance</span> {{ $total['irradiance'] }} kWh/m<sup>2</sup></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="card">
                ...
                <div class="day_month_year_vt" id="expected_day_month_year_vt_day">
                    ...
                    <div class="c-datepicker-date-editor c-datepicker-single-editor J-yearMonthDayPicker-single-expected mt10">
                        <i class="fa fa-calendar-alt"></i>
                        <input type="text" autocomplete="off" name="expectedGraphDay" id="expectedGraphDay" placeholder="Select" class="c-datepicker-data-input" value="">
                    </div>
                ...
                <div class="day_month_year_vt" id="expected_day_month_year_vt_month" style="display: none;">
                    ...
                    <div class="mt40">
                        <div class="c-datepicker-date-editor c-datepicker-single-editor J-yearMonthPicker-single-expected mt10">
                            <i class="fa fa-calendar-alt"></i>
                            <input type="text" autocomplete="off" name="expectedGraphMonth" placeholder="Select" class="c-datepicker-data-input" value="">
                        </div>
                    </div>
                ...
                <div class="day_month_year_vt" id="expected_day_month_year_vt_year" style="display: none;">
                    ...
                    <div class="mt40">
                        <div class="c-datepicker-date-editor c-datepicker-single-editor J-yearPicker-single-expected mt10">
                            <i class="fa fa-calendar-alt"></i>
                            <input type="text" autocomplete="off" name="expectedGraphYear" placeholder="Select" class="c-datepicker-data-input" value="">
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="drop_search_history_vt">
                    <div class="multiselect">
                        ...
                        <div id="checkbox">
                            <label for="one">
                            <input type="checkbox" class="historyCheckBox" name="historyCheckBox[]" id="one" value="generation" checked />Generation</label>
                            @if($plant->system_type_id != 1)
                                <label for="one">
                                <input type="checkbox" class="historyCheckBox" name="historyCheckBox[]" id="one" value="consumption" checked />Consumption</label>
                                <label for="one">
                                <input type="checkbox" class="historyCheckBox" name="historyCheckBox[]" id="one" value="grid" checked />Grid</label>
                                <label for="one">
                                <input type="checkbox" class="historyCheckBox" name="historyCheckBox[]" id="one" value="buy" checked />Buy</label>
                                <label for="one">
                                <input type="checkbox" class="historyCheckBox" name="historyCheckBox[]" id="one" value="sell" checked />Sell</label>
                            @endif
                            <label for="one">
                            <input type="checkbox" class="historyCheckBox" name="historyCheckBox[]" id="one" value="saving" />Cost Saving</label>
                            @if($plant->plant_has_emi == 'Y')
                                <label for="one">
                                <input type="checkbox" class="historyCheckBox" name="historyCheckBox[]" id="one" value="irradiance" checked />Irradiance</label>
                            @endif
                        </div>
                    </div>
                ...
                <div class="history_gr_vt">
                    <ul>
                        <li><samp class="color1_vt"></samp> Generation : <strong class="generationTotalValue"></strong></li>
                        @if($plant->system_type_id != 1)
                            <li><samp class="color3_vt"></samp> Consumption : <strong class="consumptionTotalValue"></strong></li>
                        ...
                        @endif
                        <li><samp class="color6_vt"></samp> Cost Saving : <strong class="savingTotalValue"></strong></li>
                        @if($plant->meter_type == 'Huawei' && $plant->plant_has_emi == 'Y')
                            <li><samp class="color7_vt"></samp> Irradiance : <strong class="irradianceTotalValue"></strong></li>
                        @endif
                    </ul>
                </div>
            </div>
...
<script>
                ...
                /*else if ($('.inverterTabPane')[i].id == 'messages2') {
                    ...
                    $('.pvGraphDataTabs').children('a').each(function() {
                        ...
                        if ($(this).hasClass('active')) {
                            ...
                            pvSelectedTab.push($(this).attr('id'));
                        }
                    });

                    if($.inArray("v-pills-profile-tab-pv", pvSelectedTab) !== -1) {
    ...
    function pvGraphAjax(date, pvCheckBoxArray) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#pvGraphDivv').append('<div id="plantsPVChart" style="height:320px;width:100%;"></div>')

                plantPVGraph(data, pvCheckBoxArray);
            },
            error: function(data) {
    ...
    function inverterGraphAjax(serial_no, date, time, inverterCheckBoxArray) {
        ...
        //var inverterArray = JSON.stringify(inverterCheckBoxArray);
        
        $graph_div = 'div#graphDiv_' + serial_no;
        $('#inverterGraphDiv').empty();
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#inverterGraphDiv').append('<div class="ch_tr_vt"><span></span></div><div id="inverterGraphChartDiv" style="height: 330px; width: 100%;">');

                plantInverterGraph(serial_no, data, date);
            },
            error: function(data) {
                console.log(data);
    ...
    function plantPVGraph(plantsPVGraphData, pvCheckBoxArray) {
        ...
        var dom = document.getElementById("plantsPVChart");
        var myChart = echarts.init(dom);
        var app = {};
    ...
    function plantInverterGraph(serialNo, plantsInverterGraphData, date) {
        ...
        var dom = document.getElementById('inverterGraphChartDiv');
        var myChart = echarts.init(dom);
        var app = {};
