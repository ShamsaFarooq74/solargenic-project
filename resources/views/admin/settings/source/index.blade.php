            ...
            <div class="col-xl-12">
                <div class="home-companies-area-vt">
                    <div class="btn-companies-vt">
                        <button type="button" class="btn_add_new_vt" data-toggle="modal" data-target="#addSource">
                            Add New
                        </button>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-header">
                    <h3 class="All-graph-heading-vt">Source List</h3>
