                  ...
                  <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        &copy; {{ date('Y') }} Beacon Energy Pvt. Ltd. All rights reserved.
                  ...
                  $(document).ready(function() {
                    ...
                    $('#datatable_2').DataTable({
                      ...
                      initComplete: function() {
                        ...
                        this.api().columns([4, 5]).every(function(d) {
                          var column = this;
                    ...
                    setTimeout($('#datatable_2').DataTable().page.len(10).draw(), 2000);
                    setTimeout($('#datatable_plant').DataTable().page.len(25).draw(), 2000);
                    setTimeout($('#datatable_plant').DataTable().page.len(10).draw(), 2000);
