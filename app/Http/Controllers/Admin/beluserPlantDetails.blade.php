                            ...
                            <div class="plant_single_dashb_vt">
                                ...
                                <div class="single_one_vt">
                                    ...
                                    <div class="img_text_vt">
                                        ...
                                        @endif
                                        <?php
                                                                                if(isset($plant->generation_log))
                                                                                    {
                                                                                        if($plant->generation_log->last()->current_generation == null || $plant->generation_log->last()->current_generation == 0)
                                                                                            {
                                                                                                $currentGeneration = 0;
                                                                                            }
                                                                                        else
                ...
                <div class="col-lg-8 mb-3">
                    ...
                    <div class="card mb-3 history_gr_area_vt" style="padding-bottom: 9px;">
                        ...
                        <div class="card-box" dir="ltr">
                            ...
                            <div class="history-card-box" dir="ltr" id="chartContainerHistoryData">
                                <div id="historyContainer"></div>
                                <br>
                            </div>
{{--                            <div class="energy_gener_vt">--}}
{{--                                <div class="ch_one_vt" id="chartContainerHistoryData">--}}
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <div class="card-stat-vt card_wather_vt p-0  mb-3">
                        ...
                        <div class="wather_ar_vt">
                            ...
                            @endif
                            <div class="font-span">{{ $weather ? $weather->temperature : '--' }}<sup>o</sup><span>{{ $weather ? $weather->condition : '--' }}</span></div>
...
{{--    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/echarts@5.0.0/dist/echarts.min.js"></script>--}}
    <script>
        ...
        function historyGraphAjax(types, id, date, time) {
            ...
            $('#chartContainerHistoryData').empty();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // }
                    //
                    // $('#chartContainerHistoryData div').remove();
                    // $('#chartDetailDiv').empty();
                    //
                    // var timely = '';
                    //
                    ...
                    // $('#chartContainerHistoryData').append('<div class="kWh_eng_vt">'+unit+'</div>');

                    // $('#chartContainerHistoryData').append('<div id="chartContainer" style="height: 260px; width: 100%; margin-top:-30px !important;"></div>');
                    $('#energyGenSpinner').hide();
                    console.log($('#chartContainerHistoryData'));
                    $('#chartContainerHistoryData').append('<div id="belChartContainer" style="height:300px;width:100%;"></div>');
        ...
        function plantHistoryGraph(plantsHistoryGraphData) {
            ...
            var domData = document.getElementById("belChartContainer");
            console.log(domData);
