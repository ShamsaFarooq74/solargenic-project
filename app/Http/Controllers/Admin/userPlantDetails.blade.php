            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-3 mb-lg-3">
                    ...
                    <div class="plant-area-vt py-2">
                        ...
                        <p>Battery</p>
                        <h3 class="three2">{{isset($current['battery_power_data']) ? $current['battery_power_data'] : 0}}</h3>
            ...
            <div class="row mb-3">
                ...
                @if($plant->system_type != 'All on Grid')
                    <div class="col-lg-4 mb-3 mb-lg-0">
                        ...
                        {{--                        <div class="plant-area-vt py-3">--}}
                        {{--                            <p>Daily Grid</p>--}}
                        {{--                            <h3 class="one"> {{$daily['grid']}}</h3>--}}
                        {{--                            <p>Monthly Grid </p>--}}
                        {{--                            <h3 class="two"> {{$monthly['grid']}}</h3>--}}
                        {{--                            <p>Yearly Grid </p>--}}
                        {{--                            <h3 class="three"> {{$yearly['grid']}}</h3>--}}
                        {{--                            <p>Total Grid </p>--}}
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-4 mb-3 mb-lg-0">
                    <div class="card-stat-vt hihht_vt p-0  mb-3">
                        ...
                        <div class="grpaek_vt">
                            {{--                            <div id="containerpek" style="height: 300px; padding: 80px 50px 30px 50px;"></div>--}}
                            <div class="ch_one_vt" id="containerpek"></div>
                            <div class="over_total_vt">total Peak hours Consumption <span
                                    id="total-peak-hours-consumption"></span></div>
                        </div>
                        <div class="history_gr_vt mt-0 mb-1" style="margin-top: -26px !important;">
                            {{--                            <ul>--}}
                            {{--                                <li><samp class="color4_vt"></samp> Battery Discharging : <strong class="solar_vt" id="battery-remaining">1.78kWh</strong>--}}
                            {{--                                </li>--}}
                            {{--                                <li><samp class="color5_vt"></samp> Grid Import : <strong class="grid_vt" id="grid-import">0.7--}}
                            {{--                                        kWh</strong></li>--}}
                            {{--                            </ul>--}}
                        </div>
                    </div>
                ...
                <div class=" col-md-4">
                    <div class="card-stat-vt p-0  mb-3">
                        ...
                        <div class="gr_vt">
                            ...
                            <div class="over_total_vt">total Energy Generation <span id="energyGenerationValue"></span>
                            </div>
                        </div>
                        {{--                        <div class="history_gr_vt mt-3">--}}
                        {{--                            <ul>--}}
                        {{--                                <li><samp class="color5_vt"></samp> Battery Charging : <strong class="battery_vt" id="batteryChargingValue"> 1.78--}}
                        {{--                                        kWh</strong>--}}
                        {{--                                </li>--}}
                        {{--                                <li><samp class="color4_vt"></samp> Load : <strong class="solar_vt" id="solarLoadValue">3.54 kWh</strong>--}}
                        {{--                                </li>--}}
                        {{--                                <li><samp class="color1_vt"></samp> Grid Export : <strong class="grid_vt" id="gridExportValue">7.44--}}
                        {{--                                        kWh</strong></li>--}}
                        {{--                            </ul>--}}
                        {{--                        </div>--}}
                    </div>
                ...
                <div class=" col-md-4">
                    <div class="card-stat-vt p-0  mb-3">
                        ...
                        <div class="gr_vt">
                            ...
                            <div class="over_total_vt">total Energy Consumption <span
                        ...
                        {{--                        <div class="history_gr_vt mt-3">--}}
                        {{--                            <ul>--}}
                        {{--                                <li><samp class="color5_vt"></samp> Battery Discharge: <strong class="battery_vt"> 1.78--}}
                        {{--                                        kWh</strong>--}}
                        {{--                                </li>--}}
                        {{--                                <li><samp class="color4_vt"></samp> Solar : <strong class="solar_vt">2.52 kWh</strong>--}}
                        {{--                                </li>--}}
                        {{--                                <li><samp class="color1_vt"></samp> Grid Import : <strong class="grid_vt">0.7--}}
                        {{--                                        kWh</strong></li>--}}
                        {{--                            </ul>--}}
                        {{--                        </div>--}}
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="card-stat-vt  mb-3" style="padding-bottom: 19px;">
                        <div class="card-header">
                            ...
                            <div class="on_off_area_vt">
                                @if($plant->is_online == 'Y')
                                    <div class="off_img_vt">
                                        <img title="Online" src="{{ asset('assets/images/on_off.png')}}" alt="Current"
                                             width="20">
                                    </div>
                                @elseif($plant->is_online == 'P_Y')
                                    <div class="off_img_vt">
                                        <img title="Online" src="{{ asset('assets/images/on_off_orange.svg')}}"
                                             alt="Current"
                                             width="20">
                                    </div>
                                @else
                                    <div class="off_img_vt">
                                        <img title="Online" src="{{ asset('assets/images/on_off_blue.png')}}"
                                             alt="Current"
                                             width="20">
                                    </div>
                                @endif
                            ...
                            auth()->user()->roles == 4)
                                <a class="eidt-profil-vt" href="{{ url('admin/edit-plant/'.$plant->id)}}"
                        ...
                        auth()->user()->roles == 4)
                            <h2 class="stat-head-vt"><a
                                    href="{{route('admin.edit.plant', ['id' => $plant->id])}}">{{$plant->plant_name }}</a>
                            </h2>
                        @else
                        ...
                        <div class="drop_search_history_vt">
                            <div class="multiselect">
                                ...
                                <div id="checkbox">
                                    ...
                                    @endif
                                    @if($plant->system_type_id == 4)
                                        <label for="one" class="batteryPowerCheckBox">
                                            <input type="checkbox" class="historyCheckBox" name="historyCheckBox[]"
                                                   id="one"
                                                   value="battery-power" checked/>Battery Power</label>
                                        <label for="one" class="batterySocCheckBox">
                                            <input type="checkbox" class="historyCheckBox" name="historyCheckBox[]"
                                                   id="one"
            ...
            <div class="row">
                <div class="col-lg-8 mb-3">
                    <div class="card">
                        ...
                        <!-- search and Dropdown -->
{{--                        <div class="drop_search_weather_vt button">--}}
{{--                            <div class="multiselect">--}}
{{--                                <span>Select Parameter</span>--}}
{{--                                <div class="selectBox" onclick="showWeatherCheckbox()">--}}
{{--                                    <select>--}}
{{--                                    </select>--}}
{{--                                    <div class="overSelect"></div>--}}
{{--                                </div>--}}
{{--                                <div id="checkboxWeather">--}}
{{--                                    <label for="one">--}}
{{--                                        <input type="checkbox" class="weatherCheckBox" name="weatherCheckBox[]" id="one"--}}
{{--                                               value="generation" checked/>Generation</label>--}}
{{--                                    --}}{{--                                    @if($plant->system_type_id != 1)--}}
{{--                                    <label for="one">--}}
{{--                                        <input type="checkbox" class="weatherCheckBox" name="weatherCheckBox[]" id="one"--}}
...
{{--                                    @if($plant->plant_has_emi == 'Y')--}}
{{--                                        <label for="one">--}}
{{--                                            <input type="checkbox" class="weatherCheckBox" name="weatherCheckBox[]"--}}
{{--                                                   id="one"--}}
{{--                                                   value="irradiance" checked/>Irradiance</label>--}}
{{--                                    @endif--}}
{{--                                    @if($plant->system_type_id == 4)--}}
{{--                                        <label for="one" class="batteryWeatherPowerCheckBox">--}}
{{--                                            <input type="checkbox" class="weatherCheckBox" name="weatherCheckBox[]"--}}
{{--                                                   id="one"--}}
{{--                                                   value="battery-power" checked/>Battery Power</label>--}}
{{--                                        <label for="one" class="batteryWeatherSocCheckBox">--}}
{{--                                            <input type="checkbox" class="weatherCheckBox" name="weatherCheckBox[]"--}}
{{--                                                   id="one"--}}
{{--                                                   value="soc" checked/>Soc</label>--}}
{{--                                        <label for="one">--}}
...
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <button type="submit" id="searchWeatherCheckBox">Search</button>--}}
{{--                        </div>--}}
                        {{--                    <div>--}}
                        {{--                        <button id="ExportGenerationGraph">Export</button>--}}
                        {{--                    </div>--}}
                        ...
                        <div class="day_month_year_vt" id="weather_day_month_year_vt_day">
                            <button class="btn_left_weather_vt"><i id="weatherGraphPreviousDay" class="fa fa-caret-left"></i>
                            </button>
                            <div
                            ...
                            <button class="btn_right_weather_vt"><i id="weatherGraphForwardDay" class="fa fa-caret-right"></i>
                            </button>
                        </div>
...
{{--                        <div class="day_month_year_vt" id="weather_day_month_year_vt_year" style="display: none;">--}}
{{--                            <button class="btn_left_vt"><i id="weatherGraphPreviousYear" class="fa fa-caret-left"></i>--}}
{{--                            </button>--}}
{{--                            <div class="mt40">--}}
{{--                                <div--}}
{{--                                    class="c-datepicker-date-editor c-datepicker-single-editor J-yearPicker-single-weather mt10">--}}
{{--                                    <i class="fa fa-calendar-alt"></i>--}}
{{--                                    <input type="text" autocomplete="off" name="weatherGraphYear" placeholder="Select"--}}
{{--                                           class="c-datepicker-data-input" value="">--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <button class="btn_right_vt"><i id="weatherGraphForwardYear" class="fa fa-caret-right"></i>--}}
{{--                            </button>--}}
{{--                        </div>--}}
...
{{--                                @if($plant->system_type_id != 1)--}}
{{--                                    <li><samp class="color3_vt"></samp> Consumption : <strong--}}
{{--                                            class="consumptionWeatherTotalValue"></strong></li>--}}
{{--                                    <li><samp class="color2_vt"></samp> Grid : <strong--}}
{{--                                            class="gridWeatherTotalValue"></strong>--}}
{{--                                    </li>--}}
{{--                                    <li><samp class="color4_vt"></samp> Buy : <strong--}}
{{--                                            class="buyWeatherTotalValue"></strong>--}}
{{--                                    </li>--}}
{{--                                    <li><samp class="color5_vt"></samp> Sell : <strong--}}
{{--                                            class="sellWeatherTotalValue"></strong>--}}
{{--                                    </li>--}}
{{--                                @endif--}}
{{--                                @if($plant->system_type_id == 4)--}}
{{--                                    <li><samp class="color2_vt" style="color:#f2b610"></samp> Charge : <strong--}}
{{--                                            class="chargeWeatherTotalValue"></strong>--}}
{{--                                    </li>--}}
{{--                                    <li><samp class="color4_vt" style="color:#31bfbf"></samp> Discharge : <strong--}}
{{--                                            class="dischargeWeatherTotalValue"></strong>--}}
{{--                                    </li>--}}
{{--                                @endif--}}
{{--                                <li><samp class="color6_vt"></samp> Cost Saving : <strong--}}
{{--                                        class="savingWeatherTotalValue"></strong>--}}
{{--                                </li>--}}
{{--                                @if($plant->meter_type == 'Huawei' && $plant->plant_has_emi == 'Y')--}}
{{--                                    <li><samp class="color7_vt"></samp> Irradiance : <strong--}}
{{--                                            class="irradianceWeatherTotalValue"></strong></li>--}}
{{--                                @endif--}}
                            </ul>
                        </div>
                    </div>
            ...
            {{--                            <h2>Current Local Weather</h2>--}}
            {{--                        </div>--}}
            {{--                        <div class="clander_left_vt w-100">--}}
            {{--                            <div class="day_month_year_vt" id="env_day_month_year_vt_day">--}}
            {{--                                <button><i id="weatherGraphPreviousDay" class="fa fa-caret-left"></i></button>--}}
            {{--                                <div--}}
            {{--                                    class="c-datepicker-date-editor c-datepicker-single-editor J-yearMonthDayPicker-single-env mt10">--}}
            {{--                                    <input type="text" autocomplete="off" name="weatherGraphDay" id="envGraphDay"--}}
            {{--                                           placeholder="Select" class="c-datepicker-data-input" value="">--}}
            {{--                                </div>--}}
            {{--                                <button><i id="weatherGraphForwardDay" class="fa fa-caret-right"></i></button>--}}
            {{--                            </div>--}}
            {{--                            <div class="day_month_year_vt" id="env_day_month_year_vt_month" style="display: none;">--}}
            {{--                                <button><i id="weatherGraphPreviousMonth" class="fa fa-caret-left"></i></button>--}}
            {{--                                <div class="mt40">--}}
            {{--                                    <div--}}
            {{--                                        class="c-datepicker-date-editor c-datepicker-single-editor J-yearMonthPicker-single-env mt10">--}}
            {{--                                        <input type="text" autocomplete="off" name="weatherGraphMonth" placeholder="Select"--}}
            ...
            {{--                                    </div>--}}
            {{--                                </div>--}}
            {{--                                <button><i id="weatherGraphForwardMonth" class="fa fa-caret-right"></i></button>--}}
            {{--                            </div>--}}
            {{--                            <div class="day_month_year_vt" id="env_day_month_year_vt_year" style="display: none;">--}}
            {{--                                <button><i id="weatherGraphPreviousYear" class="fa fa-caret-left"></i></button>--}}
            {{--                                <div class="mt40">--}}
            {{--                                    <div--}}
            {{--                                        class="c-datepicker-date-editor c-datepicker-single-editor J-yearPicker-single-env mt10">--}}
            {{--                                        <input type="text" autocomplete="off" name="weatherGraphYear" placeholder="Select"--}}
            ...
            {{--                                    </div>--}}
            {{--                                </div>--}}
            {{--                                <button><i id="weatherGraphForwardYear" class="fa fa-caret-right"></i></button>--}}
            {{--                            </div>--}}

            {{--                            <div class="day_my_btn_vt" id="weather_day_my_btn_vt">--}}
            {{--                                <button class="day_bt_vt active" id="day">day</button>--}}
            {{--                                <button class="month_bt_vt" id="month">month</button>--}}
            {{--                                <button class="month_bt_vt" id="year">Year</button>--}}
            {{--                            </div>--}}
            {{--                        </div>--}}
            {{--                        <div class="wather_vel_vt">--}}
            {{--                            <p> Dealy Production<span> 87.50 kWh</span></p>--}}
            {{--                            <p> Peak Hours Today<span> 87.50 h</span></p>--}}
            {{--                        </div>--}}
            {{--                        <div class="containerwather">--}}
            {{--                            <div id="containerwather" style="height: 300px"></div>--}}
            {{--                        </div>--}}
            ...
            <div class="row">
                <div class="col-lg-8 mb-3">
                    <!-- <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h2 class="All-graph-heading-vt">Battery List</h2>
                            </div>
                            <div class="table-responsive" style="margin-top: 15px;">
                                <table class="tablesaw table mb-0 tablesaw-stack" id="products-datatable">
                                    ...
                                    <tr class="text-center">
                                        <td>1</td>
                                        <td><a href="{{ route('admin.plant.battery.detail', ['id' => $plant->id])}}">1504</a>
                                        <td>Capacity</td>
                                        <td>Remaining</td>
                                        <td>Type</td>
                                        <td>Temperature</td>
                                        ...
                                        @foreach($daily_inverter_details as $key => $inverter)
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                        ...
                                                        <a href="{{ route('admin.plant.inverter.detail', ['plantId' => $plant->id, 'id' => $inv->serial_no])}}">
                                                            {{ $inv->serial_no != null ? $inv->serial_no : '00000000'}}
                                                        </a>
                                                        <br>

                                                </td>
                                                <td>{{ $inv->temperature}} &#176C</td>
                                                <td>{{ $inv->battery_capacity}}</td>
                                                <td>{{ $inv->battery_remaining}}</td>
                                            @endforeach
                                            ...
                                            <!-- <td>
                                                ...
                                                {{-- <td>{{ $plant->daily_inverter_detail ? $plant->daily_inverter_detail->last()->daily_generation : 0 }}
                                                kWh</td> --}}
                                                <td>
                                                    @foreach ($inverter as $inv)
                                                        @if($inv->daily_generation != '--')
                                                        {{ $inv->daily_generation ? $inv->daily_generation : 0 }} kWh
                                                        @else
                                                            {{$inv->daily_generation}}
                                                        @endif
                                                        <br>
                                                    @endforeach
                                                </td>
                                                ...
                                                <td>
                                                    @foreach ($inverter as $inv)
                                                        @if($inv->last_alert != '-----')
                                                            {{ date('d',strtotime($inv->last_alert)).'-'.substr(date('F', mktime(0, 0, 0, (int)date('m',strtotime($inv->last_alert)), 10)), 0, 3).' '.date('h:i A',strtotime($inv->last_alert)) }}
                                                            <br>
                                                        @else
                                                            {{$inv->last_alert}}<br>
                                                        @endif
...
{{--                    symbolOffset: [0, '-100%'],--}}
    ...
    {{--    <script type="text/javascript">--}}
    {{--        var dom = document.getElementById("containerpekhour");--}}
    {{--        var myChart = echarts.init(dom);--}}
    {{--        var app = {};--}}
    {{--        option = {--}}
    {{--            tooltip: {--}}
    ...
    {{--    </script>--}}
    {{--    <script type="text/javascript">--}}
    {{--        var dom = document.getElementById("containerpek");--}}
    {{--        var myChart = echarts.init(dom);--}}
    {{--        var app = {};--}}
    {{--        option = {--}}
    {{--            tooltip: {--}}
    ...
    {{--        --}}{{--            plantGraph(time, data.today_time, data.plant_history_graph, data.today_date, types);--}}
    ...
    {{--    <script type="text/javascript">--}}
    {{--        $(document).ready(function () {--}}
    {{--            $("#history_day_my_btn_vt13 button").click(function () {--}}
    {{--                alert('okkkkkkkkk');--}}

    {{--                $('#history_day_my_btn_vt13').children().removeClass("active");--}}
    {{--                $(this).addClass("active");--}}

    {{--                changeConsumptionDayMonthYear(history_date, history_time);--}}

    {{--            });--}}

    {{--            function changeConsumptionDayMonthYear(date, time) {--}}
    {{--                // alert(type)--}}
    {{--                console.log('hellllllllllll' + date + time)--}}
    {{--                var d_m_y = '';--}}

    {{--                $('#history_day_my_btn_vt13').children('button').each(function () {--}}
    {{--                    if ($(this).hasClass('active')) {--}}
    {{--                        d_m_y = $(this).attr('id');--}}
    {{--                    }--}}
    {{--                });--}}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            solarEnergyGraphAjaxData(history_date, history_time);
            ...
            function solarEnergyGraphAjaxData(date, time) {
