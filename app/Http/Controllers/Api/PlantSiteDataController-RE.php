...
class PlantSiteDataController extends Controller
{
                            ...
                            if($plant_inverter_final_data){
                                ...
                                if(isset($plant_inverter_final_data->numberOfInverters) && $plant_inverter_final_data->numberOfInverters != null && (int)$plant_inverter_final_data->numberOfInverters != 0) {
                                    ...
                                    for($i = 1; $i <= (int)$plant_inverter_final_data->numberOfInverters; $i++) {
                                        ...
                                        $inverter_exist = Inverter::where('siteId',$inverters_data['siteId'])->where('dv_inverter',$inverter_input['dv_inverter'])->first();
                                        if($inverter_exist){
...
//return $daily_inverter_gen_sum_for_month;
                                        ...
                                        if($DB_last_monthly_inverter_Generation > $daily_inverter_gen_sum_for_month){
                                    ...
                                    for($i = 1; $i <= (int)$plant_inverter_final_data->numberOfInverters; $i++) {
                                        ...
                                        $inverter['inverter1Power'] =      isset($inverters_data['inverter1Power']) ? $inverters_data['inverter1Power'] : null;
                                        $inverter['inverter2Power'] =      isset($inverters_data['inverter2Power']) ? $inverters_data['inverter2Power'] : null;
                                        $inverter['inverter3Power'] =      isset($inverters_data['inverter3Power']) ? $inverters_data['inverter3Power'] : null;
                                        $inverter['inverter4Power'] =      isset($inverters_data['inverter4Power']) ? $inverters_data['inverter4Power'] : null;
                                        $inverter['inverter5Power'] =      isset($inverters_data['inverter5Power']) ? $inverters_data['inverter5Power'] : null;
                                        $inverter['inverter1Energy'] =     isset($inverters_data['inverter1Energy']) ? $inverters_data['inverter1Energy'] : null;
                                        $inverter['inverter2Energy'] =     isset($inverters_data['inverter2Energy']) ? $inverters_data['inverter2Energy'] : null;
                                        $inverter['inverter3Energy'] =     isset($inverters_data['inverter3Energy']) ? $inverters_data['inverter3Energy'] : null;
                                        $inverter['inverter4Energy'] =     isset($inverters_data['inverter4Energy']) ? $inverters_data['inverter4Energy'] : null;
                                        $inverter['inverter5Energy'] =     isset($inverters_data['inverter5Energy']) ? $inverters_data['inverter5Energy'] : null;
                                        $inverter['totalInverterPower'] =  isset($inverters_data['totalInverterPower']) ? $inverters_data['totalInverterPower'] : null;
                                        $inverter['inverter1LimitValue'] = isset($inverters_data['inverter1LimitValue']) ? $inverters_data['inverter1LimitValue'] : null;
                                        $inverter['inverter2LimitValue'] = isset($inverters_data['inverter2LimitValue']) ? $inverters_data['inverter2LimitValue'] : null;
                                        $inverter['inverter3LimitValue'] = isset($inverters_data['inverter3LimitValue']) ? $inverters_data['inverter3LimitValue'] : null;
                                        $inverter['inverter4LimitValue'] = isset($inverters_data['inverter4LimitValue']) ? $inverters_data['inverter4LimitValue'] : null;
                                        $inverter['inverter5LimitValue'] = isset($inverters_data['inverter5LimitValue']) ? $inverters_data['inverter5LimitValue'] : null;
                                        ...
                                        $inverter['inverter1Uptime'] =     isset($inverters_data['inverter1Uptime']) ? $inverters_data['inverter1Uptime'] : null;
                                        $inverter['inverter2Uptime'] =     isset($inverters_data['inverter2Uptime']) ? $inverters_data['inverter2Uptime'] : null;
                                        $inverter['inverter3Uptime'] =     isset($inverters_data['inverter3Uptime']) ? $inverters_data['inverter3Uptime'] : null;
                                        $inverter['inverter4Uptime'] =     isset($inverters_data['inverter4Uptime']) ? $inverters_data['inverter4Uptime'] : null;
                                        $inverter['inverter5Uptime'] =     isset($inverters_data['inverter5Uptime']) ? $inverters_data['inverter5Uptime'] : null;
                                ...
                                if(isset($plant_inverter_final_data->numberOfInverters) && $plant_inverter_final_data->numberOfInverters != null && (int)$plant_inverter_final_data->numberOfInverters != 0) {
                                    ...
                                    $existing_totalEnergy = GenerationLog::where('plant_id',$plant->id)->where('siteId',$site->site_id)->whereDate('created_at', date('Y-m-d'))->orderBy('created_at','desc')->first();
                    ...
                    $monthlyGenerationVar = MonthlyInverterDetail::where('plant_id', $plant->id)->whereMonth('created_at', date('m'))->whereYear('created_at', date('Y'))->sum('monthly_generation');
...
//                    $monthly_Gene_FromAPI =isset($final_processed_data->monthlySolarEnergy) && $final_processed_data->monthlySolarEnergy ? $final_processed_data->monthlySolarEnergy : 0;
            ...
            foreach($plant_data as $key => $pl_data) {
                ...
                $generation_log_data = GenerationLog::where('plant_id', $pl_data->id)->where('cron_job_id', $generation_log_cron_job_id)->get();
                ...
                if($generation_log_data) {
                    ...
                    if($pl_data->system_type == 1) {
                        ...
                        else if($pl_data->meter_type == "Microtech") {
                    ...
                    $processed_curr_data['created_at'] = $generation_log_created_time;
                    $processed_curr_data['updated_at'] = $generation_log_created_time;

                    $check_time_diffrnc = ProcessedCurrentVariable::where('plant_id', $pl_data->id)->where('created_at', 'LIKE', date('Y-m-d H:i', strtotime($generation_log_created_time)).'%')->first();
    ...
    private function plant_listing_from_saltec($curr_date,$token)
    {
        if($token){

            $curl = curl_init();
            curl_setopt_array($curl, array(
                CURLOPT_URL => "https://67.23.248.117:8089/api/sites/list?size=1000&startIndex=0&sortProperty&sortOrder&isOnline",
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_CUSTOMREQUEST => "GET",
                CURLOPT_SSL_VERIFYHOST => false,
                CURLOPT_SSL_VERIFYPEER => false,
    ...
    public function plant_offline_alert($curr_Date,$plant_id, $site_id, $plant_online){
    ...
    public function plant_online_status() {
    ...
    public function total_generation_record() {
