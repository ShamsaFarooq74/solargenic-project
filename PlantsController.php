        ...
        try {
            ...
            if (count($finalPlantArray) > 0) {
                ...
                $plants = $plants->map(function ($plant) {
                    ...
                    $weatherData = Weather::whereDate('created_at', $date)->where('city', $plant->city)->first();
                    if ($weatherData) {
                        $plant['weather_link'] = $weatherData->icon;
                    } else {
                        $plant['weather_link'] = '01d';
                    }
                    return $plant;
                });
            }
...
//                $weather = Weather::whereDate('created_at', $date)->exists() ? Weather::whereDate('created_at', $date)->first()->icon : '01d';
            }
